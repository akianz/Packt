                ...
                <div class="form_div">
                    ...
                    @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="author_name" id="author_name" maxlength="250">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="genre" id="genre" maxlength="250">
                            @if ($errors->has('genre'))
                                <span class="help-block">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="isbn" id="isbn" maxlength="250">
                            @if ($errors->has('isbn'))
                                <span class="help-block">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="publisher_name" id="publisher_name" maxlength="250">
